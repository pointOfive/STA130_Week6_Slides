...
\begin{align*}
\quad\quad Y_i = {} & \beta_0 + \beta_1 \text{I}(x_i=\text{M}) + \epsilon_i\\
\quad\quad \hat y_i = {} & 166.82 + 15.79 \text{I}(x_i=\text{M})\\
\quad\quad \hat y_i = {} & \begin{cases}
\begin{array}{lr}166.82\textcolor{gray}{[\hat \beta_0]} + 15.79 \textcolor{gray}{[\hat \beta_1]} & \;\text{ if }\texttt{sex}=\text{M} \\ 166.82 (\hat \beta_0) \quad \text{[baseline]} & \text{otherwise}\\  \end{array}
\end{cases}
\end{align*}
...
\vspace{-.5cm}
\begin{align*}
Y_i = {} & \beta_0 + \beta_1 \text{I}(x_i=\text{M}) + \epsilon_i\\
\hat y_i = {} & \hat \beta_0 + \hat \beta_1 \text{I}(x_i = \text{M})\\\\
\text{I}(x_i = \text{M}) = {} & \begin{cases}
\begin{array}{lr} 1 & \;\text{ if }\texttt{sex}=\text{M} \\  0 \quad \text{[baseline]} & \text{otherwise} \end{array}
\end{cases}\\
\hat y_i = {} & \begin{cases}
\begin{array}{lr} (\hat \beta_0 +  \hat \beta_1) & \;\text{ if }\texttt{sex}=\text{M}\\ \hat \beta_0 \quad \text{[baseline]} & \text{otherwise}\\ \end{array}
\end{cases}
\end{align*}
